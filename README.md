...
![GitHub file size in bytes](https://img.shields.io/github/size/innovarew/docker-tinycore/data/rootfs-17.x-x86_64.tar.xz?label=image%20size:latest)
...
sudo make TC_URL=http://tinycorelinux.net/17.x/x86_64/
~~~
...
| [17.x-x86_64](https://github.com/innovarew/docker-tinycore/tree/17.x-x86_64)| `FROM ghcr.io/innovarew/docker-tinycore:17.x-x86_64` |
